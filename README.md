...
public class WindowApp extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        variantComboBox.setItems(FXCollections.observableArrayList(
            ...
            "Вариант 14: Замена последовательных чисел диапазоном",
            "Вариант 15: Поиск самой длинной возрастающей подпоследовательности"
        ));
    ...
    private void processData() {
        try {
            ...
            } else if (selected.equals("Вариант 14: Замена последовательных чисел диапазоном")) {
                results = processor2.processPipeline(inputData);
            } else if (selected.equals("Вариант 15: Поиск самой длинной возрастающей подпоследовательности")) {
                results = processor3.processPipeline(inputData);
            }
            
            if (results != null) {
                resultList.setItems(FXCollections.observableArrayList(results));
                statsLabel.setText("Количество чисел: " + results.length);
            }
